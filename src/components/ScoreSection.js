...
const ScoreSection = ({ overallScore,
    globalAverage,
    industryAverage,
    auditData = {},
    dataAudit = {},
        ...
        <>
            ...
            <section className="audit-report__section">
                ...
                <p className="audit-report__main_heading">
                    You are {globalAverage - overallScore} points behind the Global Average and{' '}
                    {industryAverage - overallScore} points behind your Industry Average.
                </p>
            </section>
